...
namespace Chaskis.Core
{
    ...
    public class ActionHandler : IIrcHandler
    {
        ...
        private readonly ActionHandlerConfig config;

        private readonly PrivateMessageHelper pmHelper;

        internal const string MessageRegexPattern = "\u0001ACTION (?<theIrcMessage>.+)\u0001";
        ...
        public ActionHandler( ActionHandlerConfig config )
        {
        ...
        /// </summary>
        public ActionHandlerAction LineAction
        {
            get
            {
